...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        this.container = container;
        // listen on both the container and window so cursor input is captured
        // even when page content overlays the canvas
        ...
        // also attach to window to capture pointer movement when other elements
        // are placed on top of the canvas (so the effect still reacts to the cursor)
      ...
      dispose() {
        ...
        // remove window listeners as well
